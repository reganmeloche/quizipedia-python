class WordScore:
  def __init__(self):
    ...
    self.random_score = 0
    self.repeat_score = 0
    self.word_type_score = 0

  def total(self):
    return self.length_score + self.real_word_score + self.distance_score + self.random_score + self.repeat_score + self.word_type_score
  ...
  def print_me(self):
    ...
    print('-- word type', self.word_type_score)
